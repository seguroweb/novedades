...
// Componente principal de Importar Tickets
export default function ImportarTickets() {
  ...
  const [formData, setFormData] = useState({
    sector: "Cobranzas",
    motivo: "Rechazo tarjeta o CBU",
    compania: "Prudencia",
    usuario: "Elegir usuario",
  })
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      console.log("Datos del formulario de importación:", formData)
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <nav className="flex mb-6" aria-label="Breadcrumb">
              <ol className="flex items-center space-x-2">
                ...
                <li>
                  <span className="text-gray-900 font-medium">Importar</span>
                </li>
              </ol>
            </nav>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Importar Tickets</h1>
              </div>
              <p className="text-gray-600">Carga tickets masivamente desde un archivo Excel o CSV</p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-md border border-gray-300 py-2 px-3 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                      >
                        <option value="Elegir usuario">Elegir usuario</option>
                        <option value="Natalia Mosquera">Natalia Mosquera</option>
                  ...
                  {uploadStatus && (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {uploadStatus === "uploading" && <Upload className="h-5 w-5 text-blue-600 animate-pulse" />}
                        <span
                        ...
                        >
                          {uploadStatus === "success" && "Archivo importado exitosamente"}
                          {uploadStatus === "error" && "Error: Debe seleccionar un archivo"}
                          {uploadStatus === "uploading" && "Procesando archivo..."}
                        </span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
                    <button
                      ...
                      className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-md font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <Send className="h-4 w-4" />
                      {uploadStatus === "uploading" ? "Procesando..." : "Enviar"}
                    </button>
                    {uploadStatus === "success" && (
                      <button
                        type="button"
                        onClick={resetForm}
                        className="flex items-center gap-2 bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded-md font-medium transition-colors"
                      >
            ...
            <div className="mt-6 bg-emerald-50 border border-emerald-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                <Upload className="h-5 w-5 text-emerald-600 mt-0.5" />
                <div>
                  <h3 className="font-medium text-emerald-900">Instrucciones de Importación</h3>
                  <p className="text-sm text-emerald-700 mt-1">
                    El archivo debe contener las columnas: Cliente, Asunto, Descripción, Prioridad. Asegúrate de que el
            ...
            <div className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Resultados de Importación</h3>
                <p className="text-gray-500">
                  Los tickets importados y el resumen del proceso aparecerán aquí después de la importación.
                </p>
              </div>
            </div>
          </div>
