...
export default function OperacionesConcretadas() {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <nav className="flex mb-6" aria-label="Breadcrumb">
              <ol className="flex items-center space-x-2">
                ...
                <li>
                  <span className="text-gray-900 font-medium">Operaciones concretadas</span>
                </li>
              </ol>
            </nav>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Operaciones Concretadas</h1>
              </div>
                  ...
                  <div className="p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <label htmlFor="canal" className="block text-sm font-medium text-gray-700 mb-2">
                            Canal:
                          </label>
                          <select
                            id="canal"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full rounded-md border border-gray-300 py-2 px-3 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                          >
                            <option value="Directo a Emisión por Producto">Directo a Emisión por Producto</option>
                            <option value="Por Fecha de Emisión">Por Fecha de Emisión</option>
                            <option value="Por Vendedor">Por Vendedor</option>
                            <option value="Por Canal">Por Canal</option>
