...
// Componente principal de Prima por Vendedor
export default function PrimaVendedor() {
  ...
  // Datos de ejemplo para la tabla diaria
  const dailyTableData = [
    {
      fecha: "02/06/2025",
      contratadoPAS: 0,
      contratadoAgencias: 0,
      contratadoSW: 4,
      contratadoTotal: 4,
      emisionPAS: 0,
      emisionAgencias: 0,
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <nav className="flex mb-6" aria-label="Breadcrumb">
              <ol className="flex items-center space-x-2">
                ...
                <li>
                  <span className="text-gray-900 font-medium">Prima por vendedor</span>
                </li>
              </ol>
            </nav>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Prima Vendedores</h1>
              </div>
              <p className="text-gray-600">Consulta las primas generadas por vendedor y período</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                  <div className="p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Prima Vendedores</h3>
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="flex justify-start pt-4">
                        <button
                          type="submit"
                          className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-md font-medium transition-colors"
                        >
            ...
            {showResults && (
              <div className="mt-6 space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-gray-900">Operaciones por Día</h3>
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                          {dailyTableData.map((row, index) => (
                            <tr
                              key={row.fecha}
                              className={`${row.fecha === "Total" ? "bg-yellow-50 font-semibold" : "hover:bg-gray-50"}`}
                            >
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-gray-900">Del 01/06/2025 al 12/06/2025</h3>
                      <button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
                        <Download className="h-4 w-4" />
                        Exportar
                      </button>
                      ...
                      <table className="w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                          {productTableData.map((row, index) => (
                            <tr
                              key={`${row.producto}-${row.compania}-${index}`}
                              className={`${
                            ...
                            >
                              ...
                              <td className="border border-gray-300 px-4 py-2 text-sm text-gray-700">{row.compania}</td>
            ...
            <div className="mt-6 bg-purple-50 border border-purple-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-purple-900">Prima por Vendedor</h3>
                  <p className="text-sm text-purple-700 mt-1">
                    Consulta las primas generadas por cada vendedor, desglosadas por producto y compañía. Los datos se
                    muestran tanto por día como por el período completo seleccionado.
                  </p>
                </div>
              </div>
            </div>
