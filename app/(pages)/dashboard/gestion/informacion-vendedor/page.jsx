...
export default function InformacionVendedor() {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <nav className="flex mb-6" aria-label="Breadcrumb">
              <ol className="flex items-center space-x-2">
                ...
                <li>
                  <span className="text-gray-900 font-medium">Información por vendedor</span>
                </li>
              </ol>
            </nav>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Información por Vendedor</h1>
              </div>
