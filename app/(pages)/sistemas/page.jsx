...
import { BarChart, Bell, ChevronDown, HelpCircle, LogOut, Mail, Menu, Newspaper, Phone, Settings, Shield, User, Users } from "lucide-react";
  ...
  const systems = [
    {
      ...
      name: "Novedades",
      description:
        "Accede a las últimas noticias y actualizaciones.",
      icon: Newspaper,
      url: "/novedades"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 flex items-center justify-center">
        <div className="max-w-4xl w-full bg-white rounded-lg border border-gray-100 shadow-sm p-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {systems.map((system) => (
              <Link href={system.url}>
                <div
                  key={system.id}
                  className="flex flex-col items-center p-6 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors duration-200 ease-in-out cursor-pointer border border-blue-200 shadow-sm"
                >
                  <system.icon className="h-12 w-12 text-blue-600 mb-4" />
